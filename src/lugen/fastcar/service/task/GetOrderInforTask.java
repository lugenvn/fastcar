...
public class GetOrderInforTask extends AbstractGetMethodTask{
	public GetOrderInforTask(IDelegate<AbstractTask> delegate, int id) {
		mDelegate = delegate;
		url = Const.URL_GET_ORDER_INFOR + id;
	}
}
